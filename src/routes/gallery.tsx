...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery — Aggiestays" },
      { name: "description", content: "Tour our luxury apartments through immersive video walkthroughs." },
      { property: "og:title", content: "Gallery — Aggiestays" },
      { property: "og:description", content: "Video tours of every Aggiestays apartment." },
    ],
  }),
    ...
    <section className="container-luxe py-16">
      ...
      {active && (
        <div
          ...
          className="fixed inset-0 z-50 bg-primary/95 backdrop-blur flex items-center justify-center p-4 animate-fade-in"
        >
          <video
            src={active}
            controls
            autoPlay
            className="max-w-5xl w-full max-h-[85vh] rounded-2xl shadow-luxe"

...
export const Route = createFileRoute("/locations")({
  head: () => ({
    meta: [
      { title: "Locations — Aggiestays" },
      { name: "description", content: "Apartments across Goba Lastanza, Kijitonyama, Sinza Mapambano, Morocco Square, and Moshi Town." },
      { property: "og:title", content: "Locations — Aggiestays" },
      { property: "og:description", content: "Apartments across five premier Tanzanian neighborhoods." },
    ],
  }),

...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Aggiestays — Luxury Apartments in Tanzania" },
      { name: "description", content: "Premium fully-furnished apartments in Dar es Salaam and Moshi. Instant WhatsApp booking." },
      { property: "og:title", content: "Aggiestays — Luxury Apartments in Tanzania" },
      { property: "og:description", content: "Premium fully-furnished apartments in Dar es Salaam and Moshi." },
